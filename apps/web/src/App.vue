            ...
            <div class="mx-auto max-w-3xl px-4 py-3 sm:px-6">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <nav v-if="!isPortalRoute" class="hidden items-center gap-3 text-sm text-slate-600 md:flex">
                        ...
                        <RouterLink
                            v-if="showOrgLink"
                            class="inline-flex items-center gap-2 transition-colors hover:text-slate-900"
                            to="/admin/orgs"
                        >
                        ...
                        <button
                            ...
                            class="inline-flex items-center gap-2 rounded border border-slate-200 bg-white px-3 py-1 text-xs font-medium text-slate-700 transition-colors hover:border-slate-300 hover:bg-slate-50"
                            type="button"
                            @click="handleLogout"
                        >
                            <svg class="h-4 w-4 text-slate-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.8">
